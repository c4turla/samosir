                        ...
                        <div class="col-lg-12 ms-lg-auto">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nama_nakhoda" name="nama_nakhoda" value="<?= $keberangkatan['nama_nakhoda'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="datetime-local" class="form-control" id="tanggal_masuk" name="tanggal_masuk" value="<?= $keberangkatan['tanggal_masuk'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="tanggal_berangkat" class="col-sm-3 col-form-label">Tanggal dan Jam Keberangkatan</label>
                                    <div class="col-sm-2">
                                        <input type="datetime-local" class="form-control" id="tanggal_berangkat" name="tanggal_berangkat" value="<?= $keberangkatan['tanggal_berangkat'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="floating" name="floating" value="<?= $keberangkatan['floating'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="bongkar_ikan" class="col-sm-3 col-form-label">Bongkar Ikan</label>
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" id="bongkar_ikan" name="bongkar_ikan" value="<?= $keberangkatan['bongkar_ikan'] ?>">
                                    </div>
                                </div>

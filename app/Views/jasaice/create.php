        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Tambah Jasa Ice Cruiser</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Jasa Ice Cruiser</h4>
                <p class="card-title-desc">Gunakan Form ini untuk menambah data Jasa Pemakaian Ice Cruiser.</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('ice/storeorder') ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="row mb-4">
                                ...
                                <div class="row g-0 mb-4 mt-4 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="keranjang_plastik"
                                            name="keranjang_plastik" value="<?= old('keranjang_plastik'); ?>" readonly>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_keranjang_plastik"
                                            name="ket_keranjang_plastik" value="<?= old('ket_keranjang_plastik'); ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_meja_sortir"
                                            name="ket_meja_sortir" value="<?= old('ket_meja_sortir'); ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_gerobak" name="ket_gerobak"
                                            value="<?= old('ket_gerobak'); ?>" readonly>
                                    </div>
                                </div>
                                <div class="row g-0 mb-4 align-items-center">

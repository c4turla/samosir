        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Bayar Jasa Ice Cruiser</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Bayar Jasa Pemakaian Ice Cruiser</h4>
                <p class="card-title-desc">Gunakan Form ini untuk proses pembayaran Jasa Pemakaian Ice Cruiser.</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            <form action="<?= base_url('ice/prosesbayar/' . $jasaPeralatan['id_jasa']) ?>"
                                ...
                                <div class="row g-0 mb-4 mt-4 align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="by_keranjang_plastik"
                                            name="by_keranjang_plastik" value="<?= $jasaPeralatan['by_keranjang_plastik']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="by_meja_sortir"
                                            name="by_meja_sortir" value="<?= $jasaPeralatan['by_meja_sortir']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="by_gerobak" name="by_gerobak"
                                            value="<?= $jasaPeralatan['by_gerobak']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="row g-0 mb-4 align-items-center">

        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?= base_url('/ice') ?>">Jasa</a></li>
                    <li class="breadcrumb-item active">Edit Order Jasa Ice Cruiser</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Order Jasa Ice Cruiser</h4>
                <p class="card-title-desc">Gunakan Form ini untuk mengedit data Jasa Pemakaian Ice Cruiser.</p>
            </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nama_penyewa" name="nama_penyewa"
                                            value="<?= $jasaPeralatan['nama_penyewa'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row g-0 mb-4 mt-4 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="keranjang_plastik"
                                            name="keranjang_plastik" value="<?= $jasaPeralatan['keranjang_plastik']; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_keranjang_plastik"
                                            name="ket_keranjang_plastik" value="<?= $jasaPeralatan['ket_keranjang_plastik']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="meja_sortir" name="meja_sortir"
                                            value="<?= $jasaPeralatan['meja_sortir']; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_meja_sortir"
                                            name="ket_meja_sortir" value="<?= $jasaPeralatan['ket_meja_sortir']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="gerobak" name="gerobak"
                                            value="<?= $jasaPeralatan['gerobak']; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_gerobak" name="ket_gerobak"
                                            value="<?= $jasaPeralatan['ket_gerobak']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="row g-0 mb-4 align-items-center">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" id="timbangan" name="timbangan"
                                            value="<?= $jasaPeralatan['timbangan']; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="ket_timbangan" name="ket_timbangan"
                                            value="<?= $jasaPeralatan['ket_timbangan']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="row g-0 mb-4 align-items-center">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-12">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="<?= base_url('ice') ?>" class="btn btn-danger"><i class="bx bx-arrow-back me-1"></i> Kembali</a>

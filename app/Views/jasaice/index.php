        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Pemakaian Ice Criser</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <div class="mb-4">
                            <h5 class="card-title">List Jasa Pemakaian Ice Cruiser</h5>
                        </div>
                    </div>
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            <div>
                                <a href="<?= base_url('ice-add') ?>" class="btn btn-success"><i class="bx bx-plus me-1"></i> Tambah Jasa Ice Cruiser</a>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#peralatan').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo site_url('dataice') ?>",
            columnDefs: [{
                    targets: -1,
                    orderable: false

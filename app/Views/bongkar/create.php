        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Penimbangan Ikan</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Penimbangan Ikan</h4>
                <p class="card-title-desc">Gunakan Form ini untuk menambah data penimbangan ikan.</p>
            </div>
                        ...
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('bongkar/store') ?>" method="post">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="nama_kapal" name="nama_kapal" value="<?= old('nama_kapal'); ?>" readonly>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="no_surat" name="no_surat" value="<?= esc($nomorOtomatis) ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <label for="no-surat" class="col-sm-3 col-form-label">Tanggal Bongkar</label>
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control" id="tanggal_bongkar" name="tanggal_bongkar" value="<?= old('tanggal_bongkar'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <label for="no-stblk" class="col-sm-3 col-form-label">Nomor STBL Kedatangan</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="stblk" name="stblk" value="<?= old('stblk'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="lokasi" class="col-sm-3 col-form-label">Lokasi Penimbangan</label>
                                    <div class="col-sm-4">
                                        <select class="form-control" name="lokasi" id="lokasi" data-trigger>

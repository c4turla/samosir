        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <div class="mb-4">
                            <h5 class="card-title">List Data Penimbangan Ikan</h5>
                        </div>
                    </div>
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            <div>
                                <a href="<?= base_url('bongkar-add') ?>" class="btn btn-success"><i class="bx bx-plus me-1"></i> Tambah Penimbangan Ikan</a>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#bongkar').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo site_url('dataapprove') ?>",
            columnDefs: [

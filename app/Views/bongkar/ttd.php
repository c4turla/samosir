                        ...
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('bongkar/update/' . $bongkar['id_bongkar']) ?>" method="post">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="no_surat" name="no_surat" value="<?= $bongkar['syahbandar'] ?>" disabled>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <label for="no-surat" class="col-sm-3 col-form-label">Nomor STBL Kedatangan</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="stblk" name="stblk" value="<?= $bongkar['stblk'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="no-surat" class="col-sm-3 col-form-label">Lokasi Penimbangan</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="lokasi" name="lokasi" value="<?= $bongkar['lokasi'] ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-4">

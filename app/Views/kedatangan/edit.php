                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Kedatangan</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit Data Kedatangan</h4>
                                    <p class="card-title-desc">Gunakan Form ini untuk mengubah data kedatangan.</p>
                                </div>
                                <div class="card-body p-4">

                                    <div class="row">
                                        <form action="<?= base_url('kedatangan/update/' . $kedatangan['id_kedatangan']) ?>" method="post">
                                            <?= csrf_field(); ?>

        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit Jasa Air</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Order Jasa Air Tawar</h4>
                <p class="card-title-desc">Gunakan Form ini untuk mengedit data Jasa Air Tawar.</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('jasaair/update/' . $jasaAir['id_air']) ?>"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="nama_kapal" id="nama_kapal" data-trigger>
                                            ...
                                            <?php if ($val->nama_kapal === $jasaAir['nama_kapal']) : ?>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control" id="tanggal_permintaan"
                                            name="tanggal_permintaan" value="<?= $jasaAir['tanggal_permintaan']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">

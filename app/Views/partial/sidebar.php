            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if (session()->get('role') == '4') { ?>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <span data-key="t-jasa">Menu Jasa</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?= base_url('/peralatan') ?>" data-key="t-kedatangan">Peralatan</a></li>
                            <li><a href="<?= base_url('/ice') ?>" data-key="t-kedatangan">Ice Cruiser</a></li>
                            <li><a href="<?= base_url('/air') ?>" data-key="t-air">Air</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?= base_url('/sprkeberangkatan') ?>">
                            <i data-feather="file-text"></i>
                            <span data-key="t-uploadsurat">SPR Keberangkatan</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('/pengurus/kedatangan') ?>">
                            <i data-feather="calendar"></i>
                            <span>Jadwal Kedatangan</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('/pengurus/keberangkatan') ?>">
                            <i data-feather="calendar"></i>
                ...
                <?php } else { ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?= base_url('/kapal') ?>"><span data-key="t-kapal"><?= lang('Files.Kapal') ?></span></a></li>
                            <li><a href="<?= base_url('/ikan') ?>"><span data-key="t-ikan">Jenis Ikan</span></a></li>
                            <li><a href="<?= base_url('/tangkahan') ?>"><span data-key="t-tangkahan">Dermaga</span></a></li>
                            <li><a href="<?= base_url('/pengguna') ?>"><span data-key="t-pengguna">Pengurus</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="<?= base_url('/sprkeberangkatan') ?>" data-key="t-uploadsurat">SPR Keberangkatan</a></li>
                            <li><a href="<?= base_url('/sprapprove') ?>" data-key="t-uploadsurat">Approval SPR</a></li>
                            <li><a href="<?= base_url('/uploadsurat') ?>" data-key="t-uploadsurat">Upload Dokumen SPR</a></li>
                            <?php if (session()->get('role') == '3') { ?>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                            <i data-feather="archive"></i>
                            <span data-key="t-jasa">Jasa</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?= base_url('/peralatan') ?>" data-key="t-kedatangan">Peralatan</a></li>
                            <li><a href="<?= base_url('/ice') ?>" data-key="t-kedatangan">Ice Cruiser</a></li>

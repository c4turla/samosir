                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('kapal/store') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="row mb-4">
                                    <label for="nama-kapal" class="col-sm-3 col-form-label">Nama Kapal</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="nama-kapal" name="nama_kapal" value="<?= old('nama_kapal'); ?>" style="text-transform:uppercase">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="no_izin" name="no_izin" value="<?= old('no_izin'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" min="0" oninput="this.value = 
                                                            !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" class="form-control" id="gt" name="gt" value="<?= old('gt'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="alat_tangkap" class="col-sm-3 col-form-label">Alat Tangkap</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="alat_tangkap" name="alat_tangkap" value="<?= old('alat_tangkap'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="photo" class="col-sm-3 col-form-label">Foto Kapal</label>
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control" id="photo" name="foto_kapal" value="<?= old('foto_kapal'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-select" name="tipe_kapal">
                                        ...
                                        <option>Penangkap</option>
                                        <option>Pengangkut/Pengumpul</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="tanda-selar" name="tanda_selar">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="tanggal-sipi" class="col-sm-3 col-form-label">Tanggal SIPI</label>
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="tanggal-sipi" name="tanggal_sipi">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="tanggal-akhir-sipi" class="col-sm-3 col-form-label">Tanggal Akhir SIPI</label>
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="tanggal-akhir-sipi" name="tanggal_akhir_sipi">
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" min="0" oninput="this.value = 
                                                            !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" class="form-control" id="panjang" name="panjang">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="no-siup" class="col-sm-3 col-form-label">No SIUP</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="no-siup" name="no_siup">
                                </div>
                            </div>

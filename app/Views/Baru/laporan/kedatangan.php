        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?= base_url('/lap-kedatangan') ?>">Laporan</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Laporan Data Kedatangan</h4>
                <p class="card-title-desc">Gunakan Form ini untuk laporan data kedatangan.</p>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('laporan/lap_kedatangan') ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="row mb-2">

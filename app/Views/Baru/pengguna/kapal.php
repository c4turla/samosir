                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body px-0">
                                                            <div class="px-3" data-simplebar="init" style="max-height: 400px;">
                                                                        ...
                                                                        <div class="simplebar-offset" style="right: -16.8px; bottom: 0px;">
                                                                            <div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;">
                                                                                <div class="simplebar-content" style="padding: 0px 16px;">
                                                                                    <ul class="list-unstyled activity-wid mb-90">
                                                                                        <?php
                                                                                        $key = 1;
                                                                                                ...
                                                                                                <div class="timeline-list-item">
                                                                                                    <div class="d-flex">
                                                                                                        ...
                                                                                                        <div class="flex-shrink-0 text-end">
                                                                                                            <div class="dropdown">
                                                                                                                <a class="btn btn-link text-muted shadow-none py-0 dropdown-toggle font-size-24" role="button" data-bs-toggle="dropdown"  aria-expanded="true">

        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Tambah Jenis Peralatan</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Jenis Peralatan</h4>
                <p class="card-title-desc">Gunakan Form ini untuk menambah data jenis pelaratan.</p>
            </div>
                    ...
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('alat/store') ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="row mb-4">
                                    <label for="nama-ikan" class="col-sm-3 col-form-label">Nama Peralatan</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nama-alat" name="nama_alat" value="<?= old('nama_alat'); ?>" style="text-transform:uppercase">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="nama-ikan" class="col-sm-3 col-form-label">Harga Sewa</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="harga-sewa" name="harga_sewa" value="<?= old('harga_sewa'); ?>">
                                    </div>
                                </div>
                                <div class="row mb-4">

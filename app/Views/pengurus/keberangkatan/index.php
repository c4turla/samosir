...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Jadwal Keberangkatan Kapal</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <div class="mb-4">
                            <h5 class="card-title">List Data Keberangkatan (View Only)</h5>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#tblkeberangkatan').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo site_url('datakeberangkatan_pengurus') ?>",
            columnDefs: [

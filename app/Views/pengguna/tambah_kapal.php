        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Tambah Kapal Kelolaan</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Kapal Kelolaan</h4>
                <p class="card-title-desc">Gunakan Form ini untuk menambah data Kapal Kelolaan.</p>
            </div>

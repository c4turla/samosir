												...
												<div class="carousel-inner">
													<div class="carousel-item active">
														<div class="text-center p-4">
															...
															<h4 class="mt-3 lh-base fw-normal text-white"><b>Facebook</b> PPN</h4>
															<p class="text-white-50 font-size-13"> Info terbaru tentang Pelabuhan Perikanan Nusantara di media
																sosial facebook. </p>
													...
													<a class="twitter-timeline" data-lang="id" data-width="221" data-height="290" data-theme="light" href="https://twitter.com/ppnsibolga1?ref_src=twsrc%5Etfw">Tweets by ppnsibolga</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
													</div>
													<!-- end carousel-item -->
													<div class="carousel-item">
														<div class="text-center p-4">
															...
															<h4 class="mt-3 lh-base fw-normal text-white"><b>Youtube</b> PPN</h4>
															<p class="text-white-50 font-size-13"> Info terbaru tentang Pelabuhan Perikanan Nusantara di media
																sosial youtube. </p>

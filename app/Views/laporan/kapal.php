    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Laporan Data Kapal</h4>
                <p class="card-title-desc">Gunakan Form ini untuk laporan data kapal.</p>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ms-lg-auto">
                        <div class="mt-4 mt-lg-0">
                            ...
                            <form action="<?= base_url('laporan/lap_kapal') ?>" method="post">
                                <?= csrf_field(); ?>
                                <div class="row mb-2">

...
class Kapal extends BaseController
{
    ...
    public function ajax_kapal()
    {
        ...
        return DataTable::of($kapalModel)
            ...
            ->add('action', function ($row) {
                $qr = base_url("kapal/qrcode") . '/' . $row->id;
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="' . $qr . '">QR Code</a></li>
    ...
    public function store()
    {
        ...
        if ($photo->isValid() && !$photo->hasMoved()) {
            ...
            // Jika tidak ada file yang diupload, set nilai $fileName ke null
            $fileName = null;
        }
    ...
    public function qrcode($id = null)
    {
        ...
        $qr = QrCode::create($kapal['id'] . ' - ' . $kapal['nama_kapal'])
        ...
        $logo = Logo::create(FCPATH . "assets/images/logo.jpg")
        ->setResizeToWidth(50);


        $label = Label::create($kapal['nama_kapal'])

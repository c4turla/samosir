...
class Bongkar extends BaseController
{
    ...
    public function ajax_bongkar()
    {
        ...
        $builder = $db->table('data_bongkar b ')
            ->select('b.id_bongkar, b.no_surat, b.nama_nakhoda, a.nama_kapal, b.syahbandar, b.tanggal_bongkar, b.status_approval')
    ...
    public function add()
    {
        ...
        $data['nomorOtomatis'] = $bongkars->generateNoSurat();
    ...
    public function store()
    {
        ...
        $bongkars->insert([
            ...
            'tanggal_bongkar' => $this->request->getVar('tanggal_bongkar'),
            'jam' => $this->request->getVar('jam'),
            'no_urut' => $this->request->getVar('no_urut'),
            'stblk' => $this->request->getVar('stblk'),
        ...
        session()->setFlashdata('message', 'Data Lokasi Penimbangan Berhasil Ditambahkan');
    ...
    public function update($id)
    {
        ...
        session()->setFlashdata('message', 'Lokasi Penimbangan Berhasil di Approval');
    ...
    function delete($id)
    {
        ...
        $bongkars->delete($id);
        session()->setFlashdata('message', 'Data Lokasi Penimbangan Berhasil Dihapus');
        return redirect()->to('/bongkar');
    }
}

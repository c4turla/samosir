...
class JasaIce extends BaseController
{
    public function index()
    {
        return view('jasaice/index');
    }
    ...
    public function ajax_jasa()
    {
        ...
        return DataTable::of($builder)
            ...
            ->add('action', function ($row) {
                $edit = base_url("ice/edit") . '/' . $row->id_jasa;
                $bayar = base_url("ice/bayar") . '/' . $row->id_jasa;
                $cetakorder = base_url("ice/cetakorder") . '/' . $row->id_jasa;
                $cetakperhitungan = base_url("ice/cetakperhitungan") . '/' . $row->id_jasa;
                $hapus = base_url("ice/delete") . '/' . $row->id_jasa;              
    ...
    public function add()
    {
        ...
        return view('jasaice/create', $data);
    }
    ...
    function bayar($id)
    {
        ...
        return view('jasaice/bayar', $data);
    }
    ...
    {
        $jasaPeralatan = new JasaPeralatanModel();
        $filename = date('y-m-d-H-i-s') . '-Order-Jasa-Ice';
        $data = array(
            'jasaPeralatan' => $jasaPeralatan->find($id)
        );
        ...
        // load HTML content
        $dompdf->loadHtml(view('jasaperalatan/cetakorder', $data));
    ...
    {
        $jasaPeralatan = new JasaPeralatanModel();
        $filename = date('y-m-d-H-i-s') . '-Kwitansi-Jasa-Ice';
        $data = array(
            'jasaPeralatan' => $jasaPeralatan->find($id)
        );
        ...
        $dompdf->set_option('isHtml5ParserEnabled', true);
        // load HTML content
        $dompdf->loadHtml(view('jasaperalatan/cetakperhitungan', $data));

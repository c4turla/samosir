...
class Kedatangan extends BaseController
{
    ...
    {
        return view('pengurus/kedatangan/index');
    }
    ...
    public function ajax_kedatangan()
    {
        ...
        return DataTable::of($builder)
            ...
            ->add('action', function ($row) {
                ...
                $approve = base_url("kedatangan/approve") . '/' . $row->id_kedatangan;
    ...
    public function ajax_kedatangan_pengurus()
    {
        $db = \Config\Database::connect();
        $builder = $db->table('data_kedatangan b ')
            ->select('b.id_kedatangan, a.nama_kapal, b.tanggal, b.jam, c.nama AS tangkahan, b.status, b.status_approval')
    ...
    public function stblkk()
    {
        ...
        // load HTML content
        $dompdf->loadHtml(view('kedatangan/stblkk'));
    ...
    public function approve($id)
    {
        ...
        $data['tangkahan'] = $kedatanganModel->getDermaga()->getResult();;
        $data['ikan'] = $kedatanganModel->getIkan()->getResult();;
        return view('kedatangan/approve', $data);
    }
    ...
    public function approved($id)
    {
        if (!$this->validate([
            'suhu_ikan' => [
                'rules' => 'required',
                'errors' => [
                    'required' => 'Suhu Ikan Harus diisi'
                ]
            ],
            'suhu_palka' => [
                'rules' => 'required',
                'errors' => [
                    'required' => 'Suhu Palka Harus diisi'
                ]
            ],
        ...
        session()->setFlashdata('message', 'Data Kedatangan Berhasil Di Approve');
        return redirect()->to('/kedatangan');
    }

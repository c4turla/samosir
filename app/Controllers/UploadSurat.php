...
use App\Models\UploadSuratModel;
use App\Controllers\BaseController;
use \Hermawan\DataTables\DataTable;

class UploadSurat extends BaseController
{
    public function index()
    {
        return view('uploadsurat/index');
    }
    ...
    public function ajax_upload()
    {
        ...
        return DataTable::of($builder)
            ...
            ->format('path_file', function ($row) {
                $fileUrl = base_url('images/users/surat') . '/' . $row;
                return '<a href="' . $fileUrl . '" target="_blank">Lihat Surat</a>';
            })
    ...
    public function add()
    {
        ...
        return view('uploadsurat/create', $data);
    }

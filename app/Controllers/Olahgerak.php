...
class Olahgerak extends BaseController
{
    ...
    public function ajax_olahgerak()
    {
        ...
        return DataTable::of($builder)
            ...
            ->add('action', function ($row) {
                ...
                $cetak = base_url("olah/cetak") . '/' . $row->id_olah_gerak;
    ...
    public function store()
    {
        ...
        $olahs->insert([
            ...
            'asal_dermaga' => $this->request->getVar('id_tangakahan'),
    ...
    public function cetak()
    {
        ...
        $data['olah'] = $olahs->pilih_olah($id_bongkar)->getRowArray();
        $filename = date('y-m-d-H-i-s') . '-olah-gerak';

        // instantiate and use the dompdf class
        $dompdf = new \Dompdf\Dompdf();
        $dompdf->set_option('isHtml5ParserEnabled', true);
        // load HTML content
        $dompdf->loadHtml(view('olah/cetak', $data));

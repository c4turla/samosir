...
class KedatanganModel extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'suhu_ikan', 'suhu_palka', 'harga_rata', 'mutu', 'produk', 'sampah', 'status_approval', 'status_kedatangan', 'status_olah', 'approve_by', 'status', 'no_antrian', 'input_by'
    ];
    ...
    public function getKedatanganBySearch($search)
    {
        $query = $this->query("CALL GetKedatanganBySearch(?)", [$search]);
    ...
    function getSPMobkedatangan($pengurus){
        return $this->db->query("call spMobGetKedatangan('$pengurus')")->getResult();
    }

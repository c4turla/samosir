...
class OlahgerakModel extends Model
{
    ...
    protected $allowedFields    = ['id_kedatangan','id_kapal','tanggal', 'jam', 'asal_dermaga', 'dermaga', 'update_by', 'status', 'syahbandar','input_by'];
    ...
    function pilih_olah($idolah){
        return $this->db->query("call getCetakOlah($idolah)");
    }

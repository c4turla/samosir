...
class TangkahanModel extends Model
{
    ...
    function getPosisi()
    {
        ...
        function getPosisi2()
    {
        return $this->db->query('SELECT a.id_kapal, a.dermaga, a.tanggal_berangkat, a.status, b.*, c.id, c.nama_kapal FROM data_keberangkatan a LEFT JOIN data_tangkahan b ON a.dermaga=b.id_tangkahan LEFT JOIN data_kapal c ON a.id_kapal=c.id WHERE a.tanggal_berangkat>=NOW()');

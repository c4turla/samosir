...
(function ($) {
    ...
    function layoutSetting() {
        ...
        $('#mode-setting-btn').on('click', function (e) {
            ...
            if (body.hasAttribute("data-layout-mode") && body.getAttribute("data-layout-mode") == "dark" && (darkMode === "disabled")) {
        ...
        $("input[name='layout']").on('change', function () {
            window.location.href = ($(this).val() == "vertical") ? "dashboard" : "layouts-horizontal";
        });
